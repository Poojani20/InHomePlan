...
namespace InHomePlanWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        private readonly SignInManager<IdentityUser> _signInManager;
        private readonly RoleManager<IdentityRole> _roleManager;//to initiate roles
        ...
        public RegisterModel(
            ...
            RoleManager<IdentityRole> roleManager,//using dependency injection
        ...
        //creating user roles using helper method
        public async Task OnGetAsync(string returnUrl = null)
        {
            if (!_roleManager.RoleExistsAsync(SD.Role_Houseowner).GetAwaiter().GetResult())
            {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        await _userManager.AddToRoleAsync(user, SD.Role_Houseowner);
                    }
