...
namespace InHomePlanWeb.Migrations
{
    ...
    [Migration("20230407050523_AddRegionalStaffApprovalTableToDb")]
    partial class AddRegionalStaffApprovalTableToDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InHomePlanWeb.Models.Regional_Staff_Approval", b =>
                {
                    b.Property<int>("RegionalStaffApprovalId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("RegionalStaffApprovalId"));
                    ...
                    b.HasKey("RegionalStaffApprovalId");

                    b.HasIndex("ApprovalID");

                    b.HasIndex("RegionalStaffID");

                    b.ToTable("Regional_Staff_Approval");
                });
            ...
            modelBuilder.Entity("InHomePlanWeb.Models.Regional_Staff_Approval", b =>
                {
                    b.HasOne("InHomePlanWeb.Models.Approval", "Approval")
                        .WithMany()
